...
const BlogLink = (props: Props) => {
    return (
        <li className="flex flex-col py-5">
            <Link className="hover:decoration-wavy hover:underline decoration-orange-500 font-headers text-2xl" href={'/blog/firstpost'}>Lorem loremus ipsum dolor sit amet consectetur, adipisicing e</Link>
